...
define('DATABASE_USER', 'opencats_user');
define('DATABASE_PASS', 'opencats');
define('DATABASE_HOST', 'mysql.profitmaster.clk');
...
define('MAIL_SMTP_USER', "pmbpo.notifications@gmail.com");
define('MAIL_SMTP_PASS', "Today321");
//Options: '', 'ssl' or 'tls'
