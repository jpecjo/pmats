...
ALTER TABLE joborder ADD COLUMN public int(1) NOT NULL DEFAULT 0;
...
ALTER TABLE email_template ADD COLUMN template_title VARCHAR(255) default NULL;

#r754 9-5-6 BH
UPDATE system SET schema_version = 754;
ALTER TABLE email_template CHANGE template_title tag VARCHAR(255) default NULL;
ALTER TABLE email_template ADD COLUMN title VARCHAR(255) default NULL;
...
ALTER TABLE email_template ADD `possible_variables` text;
...
ALTER TABLE `candidate_joborder` ADD `match_value` int(5) default NULL;
...
ALTER TABLE `user` ADD `is_demo` int(1) default 0;
...
ALTER TABLE `email_template` ADD `disabled` int(1) default 0;
...
ALTER TABLE email_history ADD COLUMN date datetime default NULL;
