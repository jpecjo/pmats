ALTER TABLE `activity` ADD COLUMN `name` varchar(255) default NULL;

ALTER TABLE `extra_field_settings` ADD COLUMN `is_extra` int(1) default 0;
ALTER TABLE `extra_field_settings` ADD COLUMN `presence` varchar(255) default 0;
ALTER TABLE `extra_field_settings` ADD COLUMN `fieldlabel` varchar(255) default NULL;
ALTER TABLE `extra_field_settings` ADD COLUMN `defaultvalue` TEXT default NULL;
ALTER TABLE `extra_field_settings` ADD COLUMN `maximumlength` INT(11) DEFAULT '0' ;
ALTER TABLE `extra_field_settings` ADD COLUMN `blockid` INT(11) DEFAULT '0' ;
ALTER TABLE `extra_field_settings` ADD COLUMN `helpinfo` TEXT default NULL;

ALTER TABLE `joborder` ADD COLUMN `candidate_mapping` text default NULL;
...
CREATE TABLE IF NOT EXISTS `auieo_fields` (
  ...
  `helpinfo` text COLLATE utf8_unicode_ci NULL,
  PRIMARY KEY (`id`),
