...
CREATE TABLE `system` (
  ...
  `date_version_checked` datetime default CURRENT_TIMESTAMP,
...
INSERT INTO `system` VALUES (0,0,NULL,CURRENT_TIMESTAMP,NULL,0);
UNLOCK TABLES;
...
CREATE TABLE `user_login` (
  ...
  `date_refreshed` datetime default CURRENT_TIMESTAMP,
