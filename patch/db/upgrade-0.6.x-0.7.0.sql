...
ALTER TABLE `site` ADD COLUMN `unix_name` varchar(128) default NULL;
ALTER TABLE `site` ADD COLUMN `client_id` int(11) default NULL;
...
ALTER TABLE `user` ADD COLUMN `categories` varchar(192) default NULL;

#r953 10-6-6 BH
UPDATE system SET schema_version = 953;
ALTER TABLE `attachment` ADD COLUMN `profile_image` int(1) default 0;

#r954 10-6-6 BH
UPDATE system SET schema_version = 954;
ALTER TABLE `client` ADD COLUMN `default_client` int(1) default 0;

#r955 10-6-6 BH
UPDATE system SET schema_version = 955;
ALTER TABLE `user` ADD COLUMN `session_cookie` varchar(48) default NULL;
...
ALTER TABLE `candidate_foreign` ADD COLUMN `site_id` int(11) default 0;
ALTER TABLE `client_foreign` ADD COLUMN `site_id` int(11) default 0;
ALTER TABLE `contact_foreign` ADD COLUMN `site_id` int(11) default 0;
...
ALTER TABLE `site` ADD COLUMN `is_trial` int(1) NOT NULL default '0';
ALTER TABLE `site` ADD COLUMN `trial_expires` datetime default CURRENT_TIMESTAMP;

#r959 10-13-6 BH
UPDATE system SET schema_version = 959;
ALTER TABLE `site` ADD COLUMN `account_active` int(1) NOT NULL default '1';
...
ALTER TABLE site ADD COLUMN `account_deleted` int(1) NOT NULL default '0';
