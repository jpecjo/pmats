...
class CATSSchema
{
    public static function get()
    {
        ...
        return array(
            ...
            ',
            '1' => '
                ALTER TABLE `attachment` ADD COLUMN `directory_name` VARCHAR(40) DEFAULT 0;
            ',
            '2' => '
            ...
            ',
            '22' => '
                ALTER TABLE `site` ADD COLUMN `timezone_offset` int(11) DEFAULT 0;
                ALTER TABLE `site` ADD COLUMN `time_format_24` int(1) DEFAULT 0;
                ALTER TABLE `site` ADD COLUMN `date_format_ddmmyy` int(1) DEFAULT 0;
            ',
            '23' => '
            ...
            ',
            '48' => '
                ALTER TABLE `candidate_joborder` ADD COLUMN `added_by` int(11) DEFAULT NULL;
            ',
            '49' => '
            ...
            ',
            '55' => 'PHP:
                $db->query("ALTER TABLE `user` DROP COLUMN `is_beta_tester`", true);
            ...
            ',
            '59' => '
                ALTER TABLE `attachment` ADD COLUMN `md5_sum` VARCHAR(40) NOT NULL DEFAULT \'\';
                ALTER TABLE `attachment` ADD COLUMN `file_size_kb` INT(11) DEFAULT 0;
            ',
            '60' => 'PHP:
            ...
            ',
            '61' => '
                ALTER TABLE `mailer_settings` DROP COLUMN `entered_by`;
                ALTER TABLE `job_board_settings` DROP COLUMN `entered_by`;
            ',
            '65' => '
            ...
            ',
            '67' => '
                ALTER TABLE `user` ADD COLUMN `pipeline_entries_per_page` INT(8) DEFAULT 15;
            ',
            '68' => '
                CREATE INDEX IDX_CANDIDATE_MD5_SUM ON attachment (md5_sum);
            ',
            '69' => '
                ALTER TABLE `calendar_event` CHANGE `data_item_id` `data_item_id` INT(11) NOT NULL DEFAULT -1;
                ALTER TABLE `calendar_event` CHANGE `data_item_type` `data_item_type` INT(11) NOT NULL DEFAULT -1;
                ALTER TABLE `calendar_event` CHANGE `joborder_id` `joborder_id` INT(11) NOT NULL DEFAULT -1;
            ',
            '75' => '
            ...
            '105' => '
             ...
             ',
             '156' => '
                ALTER TABLE `candidate_foreign_settings` CHANGE `alien_id` `candidate_foreign_settings_id` INT(11) ;
                ALTER TABLE `company_foreign_settings` CHANGE `alien_id` `company_foreign_settings_id` INT(11);
                ALTER TABLE `contact_foreign_settings` CHANGE `alien_id` `contact_foreign_settings_id` INT(11);
                ALTER TABLE `candidate_foreign` CHANGE `alien_id` `candidate_foreign_id` INT(11);
                ALTER TABLE `company_foreign` CHANGE `alien_id` `company_foreign_id` INT(11);
                ALTER TABLE `contact_foreign` CHANGE `alien_id` `contact_foreign_id` INT(11);
                ALTER TABLE `candidate_foreign` CHANGE `assoc_id` `candidate_id` INT(11);
                ALTER TABLE `company_foreign` CHANGE `assoc_id` `company_id` INT(11);
                ALTER TABLE `contact_foreign` CHANGE `assoc_id` `contact_id` INT(11);
             ',
             '157' => '
                ALTER TABLE `candidate_foreign_settings` CHANGE `candidate_foreign_settings_id` `candidate_foreign_settings_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `company_foreign_settings` CHANGE `company_foreign_settings_id` `company_foreign_settings_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `contact_foreign_settings` CHANGE `contact_foreign_settings_id` `contact_foreign_settings_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `candidate_foreign` CHANGE `candidate_foreign_id` `candidate_foreign_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `company_foreign` CHANGE `company_foreign_id` `company_foreign_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `contact_foreign` CHANGE `contact_foreign_id` `contact_foreign_id` INT(11) NOT NULL auto_increment;
             ',
             '158' => '
                ALTER TABLE `user` RENAME `site_user`;
                ALTER TABLE `email_history` CHANGE `user_id` `site_user_id` INT(11);
                ALTER TABLE `feedback` CHANGE `user_id` `site_user_id` INT(11);
                ALTER TABLE `mru` CHANGE `user_id` `site_user_id` INT(11);
                ALTER TABLE `saved_search` CHANGE `user_id` `site_user_id` INT(11);
                ALTER TABLE `user_login` CHANGE `user_id` `site_user_id` INT(11);
             ',
             '159' => '
                ALTER TABLE `site_user` CHANGE `user_id` `site_user_id` INT(11);
             ',
             '160' => '
                ALTER TABLE `site_user` CHANGE `site_user_id` `site_user_id` INT(11) NOT NULL auto_increment;
             ',
             '161' => '
             ...
             ',
             '163' => '
                ALTER TABLE `system` DROP COLUMN `schema_version`;
             ',
             '164' => '
                DROP TABLE IF EXISTS `work_status_type`;
             ',
             '165' => '
                ALTER TABLE `system` CHANGE `date_version_checked` `date_version_checked` datetime  default CURRENT_TIMESTAMP;
             ',
             '166' =>
             '
                ALTER TABLE `candidate_foreign` RENAME `extra_field`;
                ALTER TABLE `extra_field` ADD COLUMN `data_item_type` INT(11) DEFAULT 0;
                ALTER TABLE `extra_field` CHANGE `candidate_id` `data_item_id` INT(11) DEFAULT 0;
             ...
             '
                ...
                ALTER TABLE `extra_field_settings` ADD COLUMN `data_item_type` INT(11) DEFAULT 0;
             ...
             '169' =>
             '
                ALTER TABLE `extra_field` CHANGE `candidate_foreign_id` `extra_field_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `extra_field_settings` CHANGE `candidate_foreign_settings_id` `extra_field_settings_id` INT(11) NOT NULL auto_increment;
             ',
             '170' =>
             '
             ...
             '
                ...
                ALTER TABLE `career_portal_settings` CHANGE `job_board_settings_id` `career_portal_settings_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `career_portal_template` CHANGE `job_board_template_id` `career_portal_template_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `career_portal_template_site` CHANGE `job_board_template_id` `career_portal_template_id` INT(11) NOT NULL auto_increment;
                ALTER TABLE `career_portal_template_site` CHANGE `job_board_name` `career_portal_name` VARCHAR(255);
                ALTER TABLE `career_portal_template` CHANGE `job_board_name` `career_portal_name` VARCHAR(255);
             ',
             '173' =>
             '
                ALTER TABLE `mailer_settings` RENAME `settings`;
                ALTER TABLE `settings` ADD COLUMN `settings_type` INT(11) DEFAULT 0;
             ...
             '176' =>
             '
                ALTER TABLE `candidate` ADD COLUMN `eeo_ethnic_type_id` INT(11) DEFAULT 0;
                ALTER TABLE `candidate` ADD COLUMN `eeo_veteran_type_id` INT(11) DEFAULT 0;
                ALTER TABLE `candidate` ADD COLUMN `eeo_disability_status` VARCHAR(5) DEFAULT \'\';
                ALTER TABLE `candidate` ADD COLUMN `eeo_gender` VARCHAR(5) DEFAULT \'\';
             ',
             '177' =>
             '
             ...
             '178' =>
             '
                ALTER TABLE `attachment` CHANGE `attachment_id` `attachment_id` INT(11) NOT NULL auto_increment;
             ',
             '179' =>
             '
                ALTER TABLE `attachment` DROP INDEX IDX_text;
             ',
             '180' =>
             '
                ALTER TABLE `attachment` CHANGE `directory_name` `directory_name` VARCHAR(64);
             ',
             '182' => '
                 ALTER TABLE `attachment` ADD COLUMN `md5_sum_text` VARCHAR(40) NOT NULL DEFAULT \'\';
             ',
             '185' =>
             '
                ALTER TABLE `attachment` DROP INDEX IDX_date_modified;
             ',
             '186' => '
                 ALTER TABLE `site_user` ADD COLUMN `column_preferences` text;
             ',
             '190' => '
                ALTER TABLE `candidate` CHANGE `address1` `address` text;
                UPDATE candidate SET address = CONCAT(CONCAT(address, \'\n\'), address2) WHERE NOT address2 = \'\';
                ALTER TABLE `candidate` DROP COLUMN `address2`;
             ',
             '191' => '
                ALTER TABLE `contact` CHANGE `address1` `address` text;
                UPDATE contact SET address = CONCAT(CONCAT(address, \'\n\'), address2) WHERE NOT address2 = \'\';
                ALTER TABLE `contact` DROP COLUMN `address2`;

             ',
             '192' => '
                ALTER TABLE `company` CHANGE `address1` `address` text;
                UPDATE company SET address = CONCAT(CONCAT(address, \'\n\'), address2) WHERE NOT address2 = \'\';
                ALTER TABLE `company` DROP COLUMN `address2`;
                UPDATE company SET address = CONCAT(CONCAT(address, \'\n\'), address3) WHERE NOT address3 = \'\';
                ALTER TABLE `company` DROP COLUMN `address3`;
             ',
             '193' => 'PHP:
             ...
             ',
             '194' => '
                ALTER TABLE `candidate` ADD COLUMN desired_salary varchar(64);
                ALTER TABLE `candidate` ADD COLUMN current_salary varchar(64);
             ',
             '196' => '
             ...
             ',
             '197' => '
                ALTER TABLE `hot_list` RENAME `saved_list`;
                ALTER TABLE `hot_list_entry` RENAME `saved_list_entry`;
                ALTER TABLE `saved_list` CHANGE `hot_list_id` `saved_list_id` int(11) NOT NULL auto_increment;
             ',
             '198' => '
                ALTER TABLE `saved_list_entry` CHANGE `hot_list_entry_id` `saved_list_entry_id` int(11) NOT NULL auto_increment;
             ',
             '199' => '
                ALTER TABLE `saved_list_entry` CHANGE `hot_list_id` `saved_list_id` int(11) NOT NULL;
             ',
             '200' => '
                ALTER TABLE `candidate` ADD COLUMN middle_name varchar(32) AFTER first_name;
             ',

             /* Extra fields refactoring. */
             '201' => '
                ALTER TABLE `extra_field_settings` ADD COLUMN `extra_field_type` INT(11) NOT NULL DEFAULT '.EXTRA_FIELD_TEXT.';
             ',
             '202' => '
             ...
             ',
             '204' => '
                ALTER TABLE `extra_field_settings` ADD COLUMN `extra_field_parameters` text;
             ',
             '205' => '
                ALTER TABLE `extra_field_settings` CHANGE `extra_field_parameters` `extra_field_options` text;
             ',
             ...
             ',
             '226' => '
                ALTER TABLE `candidate` CHANGE `desired_salary` `desired_pay` varchar(64);
                ALTER TABLE `candidate` CHANGE `current_salary` `current_pay` varchar(64);
             ',
             '227' => '
                ALTER TABLE `site_user` RENAME `user`;
                ALTER TABLE `email_history` CHANGE `site_user_id` `user_id` INT(11);
                ALTER TABLE `feedback` CHANGE `site_user_id` `user_id` INT(11);
                ALTER TABLE `mru` CHANGE `site_user_id` `user_id` INT(11);
                ALTER TABLE `saved_search` CHANGE `site_user_id` `user_id` INT(11);
                ALTER TABLE `user_login` CHANGE `site_user_id` `user_id` INT(11);
             ',
             '228' => '
                ALTER TABLE `user` CHANGE `site_user_id` `user_id` INT(11);
             ',
             '229' => '
                ALTER TABLE `user` CHANGE `user_id` `user_id` INT(11) NOT NULL auto_increment;
             ',
             '230' => '
                ALTER TABLE `contact` ADD COLUMN `reports_to` INT(11) default -1;
             ',
             '231' => '
                ALTER TABLE `candidate` ADD COLUMN `is_active` INT(1) default 1;
             ',
             '240' => '
                UPDATE activity SET type = 400 WHERE type = 0;
             ',
             '241' => '
                ALTER TABLE `user` ADD COLUMN `force_logout` INT(1) default 0;
             ',
             '242' => '
             ...
             ',
             '243' => '
                 ALTER TABLE `candidate` ADD COLUMN `is_admin_hidden` INT(1) default 0;
                 ALTER TABLE `joborder` ADD COLUMN `is_admin_hidden` INT(1) default 0;
             ',
             '244' => '
                ALTER TABLE `site` ADD COLUMN `is_hr_mode` INT(1) default 0;
             ',
             '247' => 'PHP:
            ...
            ',
            '250' => '
                ALTER TABLE `http_log` ADD COLUMN `date` datetime  default CURRENT_TIMESTAMP;
            ...
            ',
            '254' => '
                ALTER TABLE `saved_list` ADD COLUMN `is_dynamic` INT(1) default 0;
                ALTER TABLE `saved_list` ADD COLUMN `datagridInstance` VARCHAR(64) default \'\';
                ALTER TABLE `saved_list` ADD COLUMN `parameters` TEXT default \'\';
                ALTER TABLE `saved_list` ADD COLUMN `created_by` INT(11) default 0;
            ',
            '255' => '
                ALTER TABLE `saved_list` CHANGE `datagridInstance` `datagrid_instance` varchar(64) default \'\';
            ',
            '256' => '
                ALTER TABLE `user` ADD COLUMN `title` VARCHAR(64) default \'\';
                ALTER TABLE `user` ADD COLUMN `phone_work` VARCHAR(64) default \'\';
                ALTER TABLE `user` ADD COLUMN `phone_cell` VARCHAR(64) default \'\';
                ALTER TABLE `user` ADD COLUMN `phone_other` VARCHAR(64) default \'\';
            ',
            '257' => '
            ...
            ',
            '260' => '
                ALTER TABLE `site` CHANGE `is_trial` `is_free` INT(1);
            ',
            '261' => '
                ALTER TABLE `site` DROP COLUMN `trial_expires`;
            ',
            '263' => '
                UPDATE site SET user_licenses = 2 WHERE is_free = 1;
            ',
            '264' => '
                ALTER TABLE `site` ADD COLUMN `file_size_kb` INT(11) default 0;
            ',
            '265' => 'PHP:
                $rs = $db->getAllAssoc(
                    "SELECT
            ...
            '266' => '
                ...
                ALTER TABLE `user` ADD COLUMN `zip_code` varchar(255);
                ALTER TABLE `user` ADD COLUMN `country` varchar(255);
            ',
            '267' => '
                ALTER TABLE `user` ADD COLUMN `can_see_eeo_info` INT(1) default 0;
            ',
            '268' => '
                ALTER TABLE `queue` ADD COLUMN `response` VARCHAR(255) default null;
            ',
            '269' => '
                ALTER TABLE `saved_list` ADD COLUMN `number_entries` INT(11) default 0;
            ',
            '270' => 'PHP:
                $rs = $db->getAllAssoc(
                    "SELECT
            ...
            ',
            '271' => '
                ALTER TABLE `saved_list` ADD COLUMN `date_created` DATETIME;
                ALTER TABLE `saved_list` ADD COLUMN `date_modified` DATETIME;
            ',
            '272' => '
                 ALTER TABLE `user` CHANGE `column_preferences` `column_preferences` longtext;
            ',
            '273' => '
                ALTER TABLE `saved_list_entry` ADD COLUMN `date_created` DATETIME;
            ',
            '274' => '
            ...
            ',
            '291' => '
                ALTER TABLE `site` ADD COLUMN `pageViews` BIGINT;
                ALTER TABLE `site` ADD COLUMN `pageViewDays` INT;
            ',
            '292' => '
                ALTER TABLE `site` ADD COLUMN `lastViewedDay` DATE;
            ',
            '293' => '
                 ALTER TABLE `site` CHANGE `pageViewDays` `page_view_days` INT;
                 ALTER TABLE `site` CHANGE `lastViewedDay` `last_viewed_day` DATE;
            ',
            '294' => '
                ALTER TABLE `site` CHANGE `page_view_days` `page_view_days` INT DEFAULT 0;
                ALTER TABLE `site` CHANGE `pageViews` `page_views` BIGINT DEFAULT 0;
            ',
            '295' => '
            ...
            ',
            '297' => '
                ALTER TABLE `import` ADD COLUMN date_created date;
                UPDATE `import` SET date_created = NOW();
            ',
            '298' => '
                ALTER TABLE `import` CHANGE date_created date_created datetime;
                UPDATE `import` SET date_created = NOW();
            ',
            '299' => '
                ALTER TABLE `site` ADD COLUMN `first_time_setup` TINYINT DEFAULT 0;
            ',
            '300' => '
            ...
            ',
            '303' => '
                ALTER TABLE `settings` CHANGE `mailer_settings_id` `settings_id` INT(11) NOT NULL auto_increment;
            ',
            '304' => '
            ...
            ',
            '307' => 'PHP:
                $db->query("ALTER TABLE `site` ADD COLUMN `localization_configured` int(1) DEFAULT 0", true);
            ',
            '308' => 'PHP:
                $db->query("ALTER TABLE `site` ADD COLUMN `agreed_to_license` int(1) DEFAULT 0", true);
            ...
            '330' => '
                ...
                ALTER TABLE `career_portal_questionnaire_history` ADD COLUMN `date` datetime NOT NULL  default CURRENT_TIMESTAMP;
            ',
            '333' => '
            ...
            ',
            '357' => '
                ALTER TABLE `joborder` ADD COLUMN `questionnaire_id` int(11) default NULL;
            ',
            '360' => '
