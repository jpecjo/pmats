...
class Projects extends Modules
{
    ...
    {
        $arrList=parent::subModuleChildLink($arrData);
        $link="";
        if($arrList)
        {
            $link=' | ';
    ...
    public static function getLink($assocArray)
    {
        $fromModule=$assocArray["fromModule"];
    ...
    public function get($projectID)
    {
        ...
        $moduleInfo=$arrModuleInfo[$this->data_item_type];
        $arrFieldsInfo=getModuleFieldsInfo($this->data_item_type);
    ...
    public function getJoborders($projectID)
    {
        ...
        $objWhere=$objSQL->addWhere($objProjectsJoborder,"actualenddate", $datetime);
        $objSQL->addWhere($objFrom,"site_id", $this->_siteID);
    ...
    public function getAll($page=1)
    {
        ...
        $objSQL->addWhere($objFrom,"site_id", $this->_siteID);
        loadPermittedRecordWhere($objSQL, $this->data_item_type);
